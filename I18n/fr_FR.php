...
return array(
    ...
    'The module will throw an error if something wrong happens whan talking to MailJet. Warning ! This could prevent user registration if Mailjet server is down or unreachable !' => 'A utiliser en développement uniquement. Le module lèvera une exception si Mailjet retourne une erreur, ou est injoignable. Attention, cela peut empêcher les utilisateurs de se connecter si le serveur Mailjet est hors service ou injoignable !',
